...
<title>Menu de opciones Profesional</title>
</head>
<body>
	<header>
	...
	<section class="fondo d-flex container-fluid vh-100 flex-column">
		<div class="bg-light-subtle d-flex flex-column justify-content-center align-items-center mt-5 rounded">
			<h1 class="mt-5">Menu de opciones para usuarios Profesionales</h1>
				<div class="d-flex justify-content-center  align-self-center flex-column gap-4 mt-5 mb-5">
					...
					<button class="btn btn-secondary "><a href="ListarProfesional">Mostrar lista de Profesionales</a></button>
					<button class="btn btn-secondary"><a href="EditarProfesional">Editar Profesionales</a></button>
					<button class="btn btn-secondary "><a href="EliminarProfesional">Eliminar Profesionales</a></button>
				</div>
		</div>
