...
<title>Menu de opciones Administrativo</title>
</head>
<body>
	<header>
	...
	<section class="fondo d-flex container-fluid vh-100 flex-column">
		<div class="bg-light-subtle d-flex flex-column justify-content-center align-items-center mt-5 rounded">
			<h1 class="mt-5">Menu de opciones para usuarios Administrativo</h1>
				<div class="d-flex justify-content-center  align-self-center flex-column gap-4 mt-5 mb-5">
					...
					<button class="btn btn-secondary "><a href="ListarAdministrativo">Mostrar lista de Administrativos</a></button>
					<button class="btn btn-secondary"><a href="EditarAdministrativo">Editar Administrativos</a></button>
					<button class="btn btn-secondary "><a href="EliminarAdministrativo">Eliminar Administrativos</a></button>
				</div>
		</div>
