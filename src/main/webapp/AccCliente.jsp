...
<body>
	...
	<section class="fondo d-flex container-fluid vh-100 flex-column">
		<div class="bg-light-subtle d-flex flex-column justify-content-center align-items-center mt-5 rounded">
			<h1 class="mt-5">Menu de opciones para Clientes</h1>
				<div class="d-flex justify-content-center  align-self-center flex-column gap-4 mt-5 mb-5">
					<button class="btn btn-primary" ><a href="CrearUsuario">Crear Cliente</a></button>
					<button class="btn btn-secondary "><a href="ListarCliente">Mostrar lista de Clientes</a></button>
					<button class="btn btn-secondary"><a href="EditarCliente">Editar Clientes</a></button>
					<button class="btn btn-secondary "><a href="EliminarCliente">Eliminar Clientes</a></button>
				</div>
		</div>
